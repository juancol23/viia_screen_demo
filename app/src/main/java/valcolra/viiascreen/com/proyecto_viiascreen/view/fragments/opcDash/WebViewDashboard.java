...
public class WebViewDashboard extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_web_view_dashboard, container, false);
        ImageView img_sense = view.findViewById(R.id.viia_sense);


        Glide.with(this).load(R.drawable.viia_sense_min).into(img_sense);
